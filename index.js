...
// Extend AlexaSkill
SpaceCore.prototype = Object.create(AlexaSkill.prototype);
SpaceCore.prototype.constructor = SpaceCore;

SpaceCore.prototype.eventHandlers.onSessionStarted = function (sessionStartedRequest, session) {
...
SpaceCore.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
 ...
 */
SpaceCore.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest, session) {
    console.log("onSessionEnded requestId: " + sessionEndedRequest.requestId + ", sessionId: " + session.sessionId);
    // any cleanup logic goes here
};

SpaceCore.prototype.intentHandlers = {
